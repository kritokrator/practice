...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/media/Data/dev/Symfony/testApp/Symfony/app/cache/prod/annotations', false);
    }
    protected function getAssetic_AssetManagerService()
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/media/Data/dev/Symfony/testApp/Symfony/app/cache/prod/assetic/config'), false)));
    ...
    {
        require_once '/media/Data/dev/Symfony/testApp/Symfony/app/cache/prod/jms_diextra/doctrine/EntityManager_514063d2d3846.php';
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_328c568a0185f4ab78774f9352900155');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_328c568a0185f4ab78774f9352900155');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_328c568a0185f4ab78774f9352900155');
        ...
        $d->setProxyDir('/media/Data/dev/Symfony/testApp/Symfony/app/cache/prod/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager514063d2d3846_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($e, $this);
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/media/Data/dev/Symfony/testApp/Symfony/app/cache/prod/jms_diextra/metadata'));
        return $instance;
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/media/Data/dev/Symfony/testApp/Symfony/app/logs/prod.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $c->setKernel($b);
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/media/Data/dev/Symfony/testApp/Symfony/app/cache/prod/profiler', '', '', 86400), $a);
        $instance->disable();
        $instance->add($c);
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('/media/Data/dev/Symfony/testApp/Symfony/app/cache/prod/jms_security/expressions');
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/media/Data/dev/Symfony/testApp/Symfony/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security'));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/media/Data/dev/Symfony/testApp/Symfony/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/media/Data/dev/Symfony/testApp/Symfony/app/cache/prod/sessions');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/media/Data/dev/Symfony/testApp/Symfony/app/cache/prod/translations', 'debug' => false));
    }
    protected function getTwigService()
    {
        $a = $this->get('security.context');
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'cache' => '/media/Data/dev/Symfony/testApp/Symfony/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/media/Data/dev/Symfony/testApp/Symfony/app/../web', false);
    }
    ...
    {
        $this->services['security.extra.metadata_factory'] = $instance = new \Metadata\MetadataFactory(new \Metadata\Driver\LazyLoadingDriver($this, 'security.extra.metadata_driver'), new \Metadata\Cache\FileCache('/media/Data/dev/Symfony/testApp/Symfony/app/cache/prod/jms_security', false));
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/media/Data/dev/Symfony/testApp/Symfony/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/media/Data/dev/Symfony/testApp/Symfony/app/cache/prod',
            ...
            'session.save_path' => '/media/Data/dev/Symfony/testApp/Symfony/app/cache/prod/sessions',
            ...
            'profiler.storage.dsn' => 'file:/media/Data/dev/Symfony/testApp/Symfony/app/cache/prod/profiler',
            ...
            'router.resource' => '/media/Data/dev/Symfony/testApp/Symfony/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/media/Data/dev/Symfony/testApp/Symfony/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.memory.path' => '/media/Data/dev/Symfony/testApp/Symfony/app/cache/prod/swiftmailer/spool',
            ...
            'assetic.cache_dir' => '/media/Data/dev/Symfony/testApp/Symfony/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/media/Data/dev/Symfony/testApp/Symfony/app/cache/prod/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/media/Data/dev/Symfony/testApp/Symfony/app/cache/prod/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/media/Data/dev/Symfony/testApp/Symfony/app/cache/prod/jms_diextra',
            'jms_di_extra.disable_grep' => false,
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.cache_warmer.controller_file_blacklist' => array(
            ),
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/media/Data/dev/Symfony/testApp/Symfony/app/cache/prod/jms_diextra/doctrine/EntityManager_514063d2d3846.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager514063d2d3846_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => '/media/Data/dev/Symfony/testApp/Symfony/app/cache/prod/jms_security',
